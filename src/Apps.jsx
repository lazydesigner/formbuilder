    ...
    <div class="bg-[#dfa674] rounded-2xl flex max-w-3xl p-5 items-center">
        <div class="md:w-1/2 px-8">
            ...
            <form action="" class="flex flex-col gap-4">
                <input class="p-2 mt-8 rounded-xl border outline-0" type="email" name="email" placeholder="Email" />
                <div class="relative">
            ...
            <div class="mt-4 text-sm flex justify-between items-center container-mr">
                ...
                <button class="hover:borderregister text-white bg-[#002D74]  rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300">Register</button>
            </div>
        </div>
