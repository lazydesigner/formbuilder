    ...
    <div className="bg-[#dfa674] rounded-2xl flex max-w-3xl p-5 items-center">
        <div className="md:w-1/2 px-8">
            ...
            <form onSubmit={HandelSubmit} className="flex flex-col gap-4">
                <input className="p-2 mt-8 rounded-xl border outline-0" type="email" value={formdata.email} onChange={HandeChange} name="email" placeholder="Email" />
            ...
            <GoogleAuth googlebtn='Login' />
            <div className="mt-10 text-sm border-b border-gray-500 py-5 playfair tooltip">Forget password?</div>

            <div className="mt-4 text-sm flex justify-between items-center container-mr">
                <p className="mr-3 md:mr-0 ">If you don't have an account..</p>
                <button className="hover:borderregister text-white bg-[#002D74]  rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300"><Link to='/singup' >Register</Link></button>
            </div>
        </div>
