  ...
  return (
    ...
    <div class="bg-[#dfa674] rounded-2xl flex max-w-3xl p-5 items-center">
        <div class="md:w-1/2 px-8">
            <h2 class="font-bold text-3xl text-[#002D74]">Signup</h2>
            {/* <p class="text-sm mt-4 text-[#002D74]">If you already a member, easily log in now.</p> */}

            <form action="" class="flex flex-col gap-4">
                <input class="p-2 mt-8 rounded-xl border outline-0" type="text" name="name" placeholder="Name" />
                <input class="p-2 rounded-xl border outline-0" type="email" name="email" placeholder="Email" />
                <div class="relative">
                    <input class="p-2 rounded-xl border w-full outline-0" type="password" name="password" id="password" placeholder="Password" />
                ...
                <button class="bg-[#002D74] text-white py-2 rounded-xl hover:scale-105 duration-300 hover:bg-[#206ab1] font-medium" type="submit">Signup</button>
            </form>
            ...
            <div class="mt-4 text-sm flex justify-between items-center container-mr">
                ...
                <button class="register text-white bg-[#002D74] rounded-xl py-2 px-5 hover:scale-105 duration-300 hover:bg-[#002c7424] font-semibold">Login</button>
            </div>
        </div>
        <div class="md:block hidden w-1/2">
            <img class="rounded-2xl max-h-[1600px]" src="https://images.unsplash.com/photo-1552010099-5dc86fcfaa38?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxfHxmcmVzaHxlbnwwfDF8fHwxNzEyMTU4MDk0fDA&ixlib=rb-4.0.3&q=80&w=1080" alt="login form" />
        </div>
    </div>
</section>
  )
